  ...
  <main class="grow flex justify-center items-center p-16">
    <div class="border border-tea-200 p-5 rounded-lg shadow-lg shadow-tea-50 max-w-screen-md">
      <div class="flex flex-col items-center justify-center w-full">
        <div class="flex flex-col items-center justify-center w-full">
          <h1 class="text-3xl font-bold text-center">Confirmation de votre nouveau mot de passe</h1>
          <p class="text-center">
            Votre mot de passe a été modifié. Vous pouvez maintenant vous connecter à votre compte.
          </p>
