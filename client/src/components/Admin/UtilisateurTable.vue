<template>
  <div class="container mx-auto mb-16">
    <div
      class="flex justify-between items-center w-full bg-gray-100 p-3 border-t border-l border-r border-gray-300"
    >
    ...
    <table class="min-w-full bg-white border border-gray-300">
      <thead class="bg-gray-100">
        <tr>
          ...
          <th @click="sortBy('id')" class="py-2 px-4 cursor-pointer hover:bg-gray-200">
            ID
      ...
      <tbody>
        <tr v-for="client in clients" :key="client._id" class="border-t hover:bg-gray-50">
          ...
          <td class="py-2 px-4 text-center">{{ client._id }}</td>
          <td class="py-2 px-4 text-center">{{ client.fullname }}</td>
          <td class="py-2 px-4 text-center">{{ client.email }}</td>
          <td class="py-2 px-4 text-center">{{ client.city }}</td>
          <td class="py-2 px-4 text-center">
            <button
